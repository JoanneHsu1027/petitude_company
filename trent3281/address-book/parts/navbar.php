<div id="sidebar" class="show">
  ...
  <div class="">
    <a style='text-decoration:none' href="./index_.php">
      <h1>Petitude</h1>
    </a>
  </div>
  ...
  <ul class="navbar-nav mb-2 mb-lg-0">
    <?php if (isset($_SESSION['admin'])): ?>
      <div class="menu-item">
        <a style="color:black; font-weight:bold" class="nav-link"><?= $_SESSION['admin']['b2b_name'] ?></a>
      </div>
      ...
      <div class="menu-item">
        <a style="background-color: #81b6be;
            color: #fff" href="logout.php">登出</a>
      </div>
    ...
    <?php else: ?>
      ...
      <div class="menu-item">
        <a class="nav-link <?= $pageName == 'login' ? 'active' : '' ?>" href="login.php">登入 <i
            class="fa-solid fa-angle-down"></i></a>
        <div class="dropdown">
          <a href="quick-login-1.php" class="align-middle">快速登入</a>
        </div>
      </div>
