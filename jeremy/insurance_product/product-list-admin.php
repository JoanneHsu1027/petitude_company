...
$title = "保險產品表";
$pageName = 'product-list-admin'; #測試時先不去list驗證, 之後要區分權限再去list
      ...
      <table class="table table-bordered table-striped">
        <thead>
          <tr>
            ...
            <th scope="col" class="text-center"><i class="fa-regular fa-pen-to-square"></i></th>
          </tr>
        </thead>
        <tbody>
          <?php foreach ($rows as $r) : ?>
            <tr>
              ...
              <td class="text-center"><a href="edit.php?insurance_product_id=<?= $r['insurance_product_id'] ?>">
...
<script>
  ...
  const deleteOne = (insurance_product_id) => {
    if (confirm(`是否要刪除編號為 ${insurance_product_id} 的資料?`)) {
      location.href = `delete.php?insurance_order_id=${insurance_product_id}`;
    }
  }
</script>
