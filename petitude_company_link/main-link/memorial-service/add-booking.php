            ...
            <div class="card">
                <div class="card-body" style="color:#0c5a67">
                    <form name="form1" onsubmit="sendData(event)">
                        ...
                        <div class="mb-3">
                            <label for="fk_project_id" class="form-label">方案編號</label>
                            <input type="text" class="form-control" id="fk_project_id" name="fk_project_id">
                            <div class="form-text"></div>
                        </div>
                        <div class="mb-3">
                            <label for="fk_reservation_id" class="form-label">預約參觀號碼</label>
                            <input type="text" class="form-control" id="fk_reservation_id" name="fk_reservation_id">
                            <div class="form-text"></div>
                        </div>
                        <div class="mb-3">
                            <label for="booking_date" class="form-label">訂購日期</label>
                            <input type="date" class="form-control" id="booking_date" name="booking_date">
                            <div class="form-text"></div>
                        </div>
                        <div class="mb-3">
                            <label for="booking_note" class="form-label">備註</label>
                            <textarea class="form-control" name="booking_note" id="booking_note" cols="30"
                                rows="3"></textarea>
                        </div>
