...
<div class="container" style="max-width: 1600px">
    <div class="d-flex flex-row bd-highlight mb-3">
        <div class="p-2 bd-highlight">
            <button type="button" class="btn btn-primary"><a class=" <?= $pageName == 'product_imgs_add' ? 'active' : '' ?>" href="product_imgs_add.php" style="Text-decoration:none; color:white">新增圖片 <i class="fa-solid fa-circle-plus"></i></a></button>
        </div>
        <div class="p-2 bd-highlight">
                ...
                <tbody>
                    <?php foreach ($rows as $r) : ?>
                        <tr style="vertical-align: middle;">
                            <td style="text-align: center"><?= $r['picture_id'] ?></td>
                            <td style="text-align: center"><?= $r['fk_product_id'] ?></td>
                            <td style="text-align: center"><?= $r['picture_name'] ?></td>
                            <td><?= $r['picture_url'] ?></td>
